...
// // 		//Calculate new dimensions for extruded tiles
// // 		var extrudedTileWidth = tileWidth + extrudeAmount * 2;
// // 		var extrudedTileHeight = tileHeight + extrudeAmount * 2; 
...
// // 		for(let y = 0; y < numRows; y++){
// // 			for(let x = 0; x < numCols; x++){
// // 				copyTiles(image,x,y,1,1)
// // 				.then(
// // 					response => tiles.push(response)
// // 				);					
// // 			}
// // 		}
// // 		extrudedTilemap.write(output);
...
// // };
// // async function copyTiles(src,x,y, offsetX, offsetY){
// //   	var srcX = x * tileWidth;
// //   	var srcY = y * tileHeight;
// //   	var destX = x * extrudedTileWidth;
// //   	var destY = x * extrudedTileHeight;
// //   	try{
// // 		//Original tile
// // 		extrudedTilemap.blit(src, destX + offsetX , destY + offsetY, srcX ,srcY ,tileWidth,tileHeight);

// // 		//Edges: Top, Left, Right, Bottom
// // 		extrudedTilemap.blit(src, destX + offsetX, destY, srcX , srcY , tileWidth, 1);
// // 		extrudedTilemap.blit(src, destX, destY + offsetY, srcX , srcY , 1, tileHeight);
// // 		extrudedTilemap.blit(src, destX + offsetX + tileWidth, destY + offsetY, srcX + tileWidth - 1 ,srcY , 1, tileHeight);
// // 		extrudedTilemap.blit(src, destX + offsetX, destY + offsetY + tileHeight, srcX ,srcY + tileHeight - 1 , tileWidth, 1);

// // 		// //Corners: Top-Left, Top-Right, Bottom-Left, Bottom-Right
// // 		extrudedTilemap.blit(src, destX, destY, srcX ,srcY , 1, 1);
// // 		extrudedTilemap.blit(src, destX + offsetX + tileWidth, destY, srcX + tileWidth - 1,srcY , 1, 1);
// // 		extrudedTilemap.blit(src, destX, destY + offsetY + tileHeight, srcX ,srcY + tileHeight - 1, 1, 1);
// // 		extrudedTilemap.blit(src, destX + offsetX + tileWidth, destY + offsetY + tileHeight, srcX + tileWidth - 1,srcY + tileHeight - 1, 1, 1);
// // 		return "tile copied";
// // 	}catch(err){
// // 		console.log('something went wrong while copying tiles');
// // 	}
// // }
// // tileExtruder(32,32,'./test-images/tileset1', './output/map.png');